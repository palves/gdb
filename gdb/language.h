...
struct language_defn
  {
    ...
    symbol_name_cmp_ftype *(*la_get_symbol_name_cmp)
...
compare_symbol_name_ftype *language_get_compare_symbol_name
  (const language_defn *lang, symbol_name_match_type match_type,
   const char *lookup_name,
   size_t lookup_name_len);
