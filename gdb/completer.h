...
struct completion_tracker
{
  ...
  /* Get a reference to the shared (between all the multiple symbol
     name comparison calls) symbol_name_match_result object, ready for
     another symbol name match sequence.  */
  symbol_name_match_result &reset_symbol_name_match_result ()
  {
    symbol_name_match_result &res = m_symbol_name_match_result;
...
private:
  ...
  symbol_name_match_result m_symbol_name_match_result;
